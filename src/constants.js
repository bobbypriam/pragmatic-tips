export default {
  TIPS: [
    ...
    },
    {
      ...
      description: 'Don\'t be swayed by vendors, media hype, dogma. Analyze information in terms of you and your project.'
    },
    {
      title: 'It\'s both what you say and the way you say it',
      description: 'There\'s no point in having great ideas if you don\'t communicate them efficiently'
    },
    {
    ...
    },
    {
      ...
      description: 'Assertions validate your assumptions. Use them to protect your code from an uncertain world.'
    },
    {
    ...
    },
    {
      ...
      description: 'Invest in the abstraction, not the implementation. Abstractions can survive the barrage of changes from different implementations and new technologies.'
    },
    {
    ...
    {
      title: 'Build documentation in, don\'t bolt it in',
      description: 'Documentation created separately from code is less likely to be correct and up to date.'
    },
    {
      title: 'Gently exceed your user\'s expectations',
      description: 'Come to understand your users\' expectations, then deliver just that little bit more.'
    },
    {
